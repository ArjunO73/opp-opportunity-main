...
({
    ...
    disableEditMode : function (cmp) {
        cmp.set("v.ShowFastOptyLineItemOverLay", "Hide");
        var createEvent = cmp.getEvent("OppAppCloseOverlay");
        createEvent.setParams({ "OverlayIdentifier": "AddProducts"});
        createEvent.fire();
    },
    doInit : function(component, event, helper){
        if(typeof(component.get("v.items")) == "undefined" || component.get("v.items").length == 0){
            if(component.get("v.ShowFastOptyLineItemOverLay") == "show")
